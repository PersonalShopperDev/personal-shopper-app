...
export const HistoryScreenOptions = createStackOption({ headerTitle: '결제내역' });
export type HistoryScreenParams = ScreenParams<undefined>;
export default function HistoryScreen({
  navigation,
}: ScreenProps<MatchingStackParamList, 'HistoryScreen', MatchingStackNavigationProps>) {
  useLayoutEffect(() => {
  ...
  return (
    <BasicCenter
      ...
      contents={<WebViewScreenOnlyMain style={{ flex: 1 }} uri={`/history`} />}
    />
  );
}
